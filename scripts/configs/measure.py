...
space_between_etiqueta = 300.0  # 200.0
margin_top_bottom = 250.0  # 250.0
...
class Annot_morfoestructuras_volcanicas:
    def __init__(self):
        ...
        self.distancia_conjunto_volcanico = -500  # VALIDAR INFORMACION
...
class simbol:
    def __init__(self, xini, yini):
        ...
        self.contemp = {1: self.width + dest.col_01_suma, 2: self.width + dest.col_02_suma,
                        3: self.width + dest.col_03_suma}
        self.xini = xini
        self.yini = yini + 125
        self.addsp = margin_top_bottom
        self.addcr = 125  #correcion para aumentar tamano de celda en caso el primer valor sea serie_adi
        self.sercen = 175 #correccion para aumentar el tamano de celda de valores unicos 150
...
class Coords:
    ...
    def getCoord(self):
        ...
        for k, v in self.state.items():
            if k == 1:
                self.C1["xfin"] = sum([acumulator, dest.col_01_grup, dest.col_01_form_depo, dest.col_01_marg_form_etiq,
                                       width_etiqueta * v, dest.col_01_suma * v])
                ...
                self.C3["xfin"] = sum(
                    [acumulator, dest.col_03_batol, dest.col_03_super_unid, dest.col_03_unid, dest.col_03_pluton,
                     dest.col_03_marg_plut_etiq, width_etiqueta * v, dest.col_03_suma * v])
